...
${convergenceInstruction ? `\n[Adaptive convergence]\n${convergenceInstruction}\n- At synthesize, create at most 3 consolidated nodes.\n- At prioritize, create at most 2 nodes and prefer Option, Decision, Risk, or Constraint.\n- At conclude, create 1–2 nodes and ensure the primary node is a Decision that records the chosen direction, rationale, accepted trade-off, and next action.\n` : ""}
