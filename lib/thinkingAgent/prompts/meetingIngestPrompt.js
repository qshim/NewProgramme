...
- Keep reasoning unit labels and content in English so persisted graph nodes use one language.
- Write chunk_summary, working_memory descriptions, and executive_memory descriptions in ${responseLanguage}.
- Keep existing node titles, project names, speaker names, ids, category names, relationship labels, and repeated_issue_keys exactly as provided or in English.
